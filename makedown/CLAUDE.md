...
**周期定义**：每周四 00:00 至下周三 23:59 为一个报告周。周三 23:59 为本周截止线，周四起进入下一周。

**周数计算**（基准：Week01 = 2026-06-11 Thu ~ 2026-06-17 Wed）：
```
Week01: 06/11 Thu – 06/17 Wed
Week02: 06/18 Thu – 06/24 Wed
Week03: 06/25 Thu – 07/01 Wed
...
```
当前周数 = 从 2026-06-11 起算，每过 7 天 +1。周三 23:59 之后即进入下一周。

**提交规则**：按 `模板/report.md` 模板撰写，存放路径 `weekly-report/weekXX/report.md`（XX 为两位数，如 week01、week02）。写完后执行：
```bash
